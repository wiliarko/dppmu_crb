...
private function formatDataRead($style, $data){
    ...
    switch ($numFmt){
        ...
        case "20": // = 'h:mm';
        case "21": // = 'h:mm:ss';
            return date("H:i", 60*60*24* ($data - self::Date_Bias)); //by: me@irvanfauzie.com //strtotime('2015-10-01 23:30:00')
			//return date("H:i", 60*60*24* ($data - self::Date_Bias) + 1443717000); //by: me@irvanfauzie.com //strtotime('2015-10-01 23:30:00')
...
/*private*/ public static function letter2index($strLetter){
    $x = 0;
    $nLength = ord("Z")-ord("A")+1;
