		...
		<div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-lg-4">
                <div class="title-action">
                    <a href="<?= $pageInfo['url_module'].'add_users' ?>" class="btn btn-primary"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;Add User </a>
                </div>
            </div>
            <div class="col-lg-1">
            </div>
                                    ...
                                    if($tablelist['row']->num_rows()){
                                        ...
                                        foreach($tablelist['row']->result() as  $arval){
                                            ...
                                            echo '<tr>
                                                    ...
                                                    <td>'.$arval->updated.'</td>
                                                    <td align="center">
                                                        <a href="'.$pageInfo['url_module'].'edit_users/'.$arval->user_id.'" data-toggle="tooltip" title="Edit '.$arval->first_name.'"><button class="btn btn-success btn-circle" type="button"><i class="glyphicon glyphicon-pencil"></i></button></a>
                                                    </td>
                                                </tr>       
                                            ';
                                            $no++;
