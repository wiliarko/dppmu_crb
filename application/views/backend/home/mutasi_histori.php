                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <div style="width: 49%; float:left;"><h5>List Histori</h5></div>
                            <div style="width: 49%; float: left; text-align: right;"><a href="<?php echo base_url() ?>backend/home/mutasi_collector">back</a></div>
                        </div>
